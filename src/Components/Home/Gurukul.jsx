...
export default function Gurukul(){
    return(
        <div className='gurukul-outer-wrapper out-max-wdh'>
            <div className='gurukul-inner-wrapper max-wdh'>
                ...
                <div className='right'>
                    ...
                    <div className='guruRight'>
                        ...
                        <div className='info'>
                            ...
                            <p>We Have Brought Experienced Experts of Astro-space To Pass This Magical Divine Knowledge To You. </p>
                        </div>
                    </div>
                    <div className='guruRight'>
                        <div className='rightImg'>
                        ...
                        <div className='info'>
                            ...
                            <p>Join the team of path-providers and Guide aspiring astrologers to achieve their fate !</p>
                        </div>
                    </div>
                </div>
            </div>
